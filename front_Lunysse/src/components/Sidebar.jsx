...
>
      ...
      {/* Sidebar */}
<div className={`fixed left-0 top-0 h-full w-64 bg-background shadow-xl transform transition-transform duration-300 z-40 ${
...
<div className="flex flex-col h-full">
          ...
          {/* Logo */}
<div className="flex items-center space-x-3 p-6 border-b border-dark">
<img src="/logo.png" alt="Lunysse" className="w-10 h-10 rounded-lg" />
<div>
<span className="text-xl font-bold text-dark">Lunysse</span>
<p className="text-xs text-dark">Sistema Psicológico</p>
</div>
</div>
...
<p className="text-xs text-dark capitalize">{user?.type}</p>
</div>
</div>
</div>
...
<Link
                    ...
                    className={`flex items-center space-x-3 px-4 py-3 rounded-xl transition-colors ${
                      ...
                      isActive(link.to)
                        ...
                        : 'text-dark/70 hover:text-light hover:bg-white/10'
...
<button
              ...
              className="flex items-center space-x-3 w-full px-4 py-3 text-dark hover:text-light hover:bg-white/10 rounded-xl transition-colors"
>
<LogOut size={20} />
<span>Sair</span>
</button>
